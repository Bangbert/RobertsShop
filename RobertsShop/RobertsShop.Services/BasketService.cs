...
namespace RobertsShop.Services
{
    class BasketService : IBasketService
    {
        ...
        public List<BasketItemViewModel> GetBasketItems(HttpContextBase _httpContext)
        {
        ...
        public BasketSummaryViewModel GetBasketSummary(HttpContextBase _httpContext)
        {
            Basket basket = GetBasket(_httpContext, false);
            ...
            if (basket != null)
            {
                ...
                // ?? checks if count = null then retunrs 0 else returns value
